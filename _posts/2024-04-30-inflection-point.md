...
*There are a lot of related ideas from [my big philosophical treatise](https://nicholasachow.substack.com/p/musings) that I tried to distill into a ten-minute talk. Some students came up to me afterwards and thanked me, so it seems like my talk was at least somewhat useful.*
...
The difference is that Brooke had a deliberate process, while Ariel did not. Ariel might have been more driven and had more intellectual horsepower, but she was chasing a past that no longer existed. Ariel lived in a state of continuous failure; it wasn't until thirty years later that she had finally "succeeded," only to find out that this wasn't what she wanted. Plus, in her feverish climb to the top, she had never taken any time to enjoy the hike — that possibility had never occurred to her.
...
* I [lectured at Stanford on LLMs](https://nicholasachow.substack.com/p/writing-in-the-age-of-chatgpt)
* Now I'm investing and [building in AI](https://nicholasachow.substack.com/p/how-to-build-products-with-ai)
...
I took the video clip of our closest match, spent weeks figuring out a way to encode tennis rallies as tensors in a high-dimensional space, got a crash course in Python and its scientific computing libraries, and eventually ended up writing a twenty page paper with statistical analysis to determine an optimal strategy to win. I even dropped 20 pounds to execute this strategy. I called this Project Federer, named after my favorite tennis player.
