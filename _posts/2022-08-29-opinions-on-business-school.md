...
The short-term tradeoff is rarely worth the long-term one. Make sure to make space for whatever you need to recharge — exercising, eating properly, sleep — and to protect that even more fiercely than anything else. The quote from Greg McKeown's *Essentialism* holds:
...
Find people who are "[forces of nature](https://blog.samaltman.com/how-to-be-successful)" and share your values, and spend time with these people. The current environment programs the brain, but the clever brain can choose its surrounding environment — be the clever brain.
